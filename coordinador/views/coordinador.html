<!-- ============================================================
     ...
     Coordinador · Portal de Nómina · Óptica Visión de Águila
     ============================================================ -->
...
<div class="min-h-[70vh] flex items-center justify-center px-4 fade-in">
  <div class="text-center max-w-sm">
    ...
    <p class="text-slate-500 text-sm mb-6">Este módulo estará disponible próximamente.</p>
    <button onclick="ingresarAsesor()" class="text-sm text-verde-oscuro underline">← Volver al inicio</button>
  </div>
</div>
